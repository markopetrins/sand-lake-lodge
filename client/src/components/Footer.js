      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        <div className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-3 group">
            <img src="/sand-lake-shores/cabin_icon.png" alt="Sand Lake Shores" className="w-6 h-6 md:w-8 md:h-8 group-hover:scale-110 transition-transform duration-300" />
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm">
            ...
            <div className="hidden sm:block w-1 h-1 bg-amber-400 rounded-full"></div>
            <Link to="/features" className="text-amber-700 hover:text-amber-800 font-medium transition-colors duration-300 hover:underline">
              Features
            </Link>
            <div className="hidden sm:block w-1 h-1 bg-amber-400 rounded-full"></div>
            <Link to="/gallery" className="text-amber-700 hover:text-amber-800 font-medium transition-colors duration-300 hover:underline">
              Gallery
            </Link>
            <div className="hidden sm:block w-1 h-1 bg-amber-400 rounded-full"></div>
          ...
          <div className="mt-4 pt-3 border-t border-amber-300">
            <p className="text-amber-600 text-xs">
              © 2024 Sand Lake Shores. All rights reserved.
            </p>
          </div>
        </div>
      </div>
